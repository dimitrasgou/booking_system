...
//
//    /**
//     * Συνάρτηση που προσθέτει παραστάσεις στη λίστα
//     */
...
//
//    /**
//     * Συνάρτηση που αφαιρεί φοιτητές από τη λίστα
//     *
//     * @param Code Dexetai ως παράμετρο δέχεται τον κωδικό της Παραστασης
//     */
//
//
...
//
//    /**
//     * συνάρτηση που δείχνει όλους τους φοιτητές που υπάρχουν στη λίστα με όλα τα χαρακτηριστικά τους
//     */
...
//
//    /**
//     * Αναζητάει φοιτητή και εμφανίζει φοιτητή με βάση το επίθετο
//     * @param Surname Δέχεται ως παράμετρο το επίθετο του φοιτητή
//     */
...
//
//    /**
//     * Αναζητάει φοιτητή και εμφανίζει φοιτητή με βάση το τηλέφωνο
//     * @param Phone Δέχεται ως παράμετρο το τηλέφωνο του φοιτητή
//     */
//
//
//    /**
//     * η συνάρτηση που καλεί το κεντρικό μενού με τις διαθέσιμες λειτουργίες τις εφαρμογής
//     */
//    private void Menu() {
//
...
//
//    /**
//     * Ζητάει από το χρηστη να καταχωρήσει τα απαραίτητα στοιχεία για να δημιουργήσει έναν νεο φοιτητή
//     * @return Επιστρέφει τον καινούριο φοιτητή
//     */
...
//
//    /**
//     * Αναζητάει αν υπάρχει φοιτητής με συγκεκριμένο επίθετο στη λίστα
//     * @param Surname Δέχεται ως παράμετρο το επίθετο του φοιτητή
//     * @return Επιστρεφει τον φοιτητή που έχει το επίθετο που δόθηκε η επιστρέφει null σε περίπτωση που ο φοιτητής δεν υπάρχει
//     */
//
//    /**
//     * Επιτρεπει να γίνει τροποποίηση στα χαρακτηριστικά υπάρχοντος φοιτητή, η αναζήτηση γίνεται με βάση το επίθετο
//     * @param Surname Δέχεται ως παράμετρο το επίθετο
//     */
...
//        int choice;
//
//        //Γίνεται δημιουργία και εισαγωγή φοιτητών στο φοιτητολόγιο με την καταχώρηση καρφωτών χαρακτηριστικών
//
...
//        main.addClient(P5);
//
//            /*το μενού έχει τοποθετηθεί μέσα σε μία  do..while ετσι ώστε ο χρήστης να επιλεγει τις λειτουργίες που θελει να κάνει
//            όσες φορες θέλει */
//
//            /*'Εχει χρησιμοποιηθεί η switch για τη διεκπεραίωση των επιλογών με βάση τον αριθμό της κάθε λειτουργίας που φαίνεται στο μενού.
//             'Eπειτα απο την εκτέλεση του κάθε case υπάρχει break έτσι ώστε να μη εκτελούνται οι εντολές που περίεχονται στα επόμενα cases*/
//
...
//
//    /**
//     * Παγώνει το πρόγραμμα και δίνει την επιλογή στο χρήστη να πατήσει <<Enter>> για να συνεχίσει παρακάτω
//     */
